        ...
        >
            ...
            >
                ...
                <div className="flex gap-2 w-full items-center">
                    ...
                    <span
                        data-testid="selected-date-range-text"
            ...
            <div
                data-testid="date-range-selector-dropdown"
                ...
                <div className="flex justify-center" data-testid="react-datepicker-wrapper">
                    <DatePicker
                        onChange={onChange}
                        startDate={startDate}
                        endDate={endDate}
                ...
                <div className="w-full flex justify-end items-center gap-2">
                    ...
                    <button
                        data-testid="date-range-apply-button"

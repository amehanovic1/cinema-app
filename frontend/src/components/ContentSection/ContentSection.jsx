...
const ContentSection = ({ title, linkTo = null, items, getAll, renderItem }) => {
    ...
    return (
        <div data-testid = "content-section">
            ...
            <div className="grid gap-4 justify-center grid-cols-[repeat(auto-fit,minmax(8rem,1fr))]" data-testid="section-grid">  
                {
            ...
            {items?.content?.length > 0 && (
                <div className="w-full flex justify-center mt-4 sm:mt-6 md:mt-8 lg:mt-10" data-testid="section-pagination">
                    <Pagination
                        number={items.number}

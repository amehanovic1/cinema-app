    ...
    return (
        ...
        >
            ...
            <div className="max-w-xl flex flex-col gap-4 items-center justify-center 
                ...
                {title && (
                    <h1 className="font-semibold text-neutral-800" data-testid="no-data-title">
                        {title}
                    </h1>
                )}

                {text && (
                    <p className="font-normal text-neutral-600 text-center" data-testid="no-data-text">
                        {text}
                    </p>
                )}

                {actionText && (
                    <h1 className="font-semibold text-dark-red underline" data-testid="no-data-action">
                        {actionText}
                    </h1>
                )}

    ...
    return (
        <>
            ...
            <div
                ...
                className="fixed top-16 right-0 fixed z-50 
                            h-[calc(100vh-64px)] 
                            bg-neutral-800 
                            flex flex-col gap-6 
                ...
                <div className="flex items-center justify-center gap-2" data-testid="drawer-logo-section">
                ...
                <div className="relative flex items-center justify-center">
                    ...
                    <h1
                        ...
                        className="flex justify-center text-neutral-300 font-bold text-xl sm:text-2xl"
                    >
                        {title}
                    </h1>
                </div>

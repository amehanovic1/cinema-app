    ...
    return (
        <>
            <div className="flex flex-col items-center gap-1 sm:gap-2 md:gap-3 mb-4 sm:mb-6">
                <h1 className="font-bold text-sm sm:text-base md:text-lg lg:text-xl text-neutral-800">
                    {name} Seats
                </h1>
            ...
            <ul className="list-disc list-inside text-left text-neutral-800 space-y-0.5 sm:space-y-1 md:space-y-2 lg:space-y-3 self-start">
                {description && description.map((item, index) => (
                    <li key={index} className="flex flex-row justify-start gap-0.5 sm:gap-1 md:gap-2 items-center">
                        ...
                        <span className="font-normal text-[10px] sm:text-xs md:text-sm lg:text-base">{item}</span>
                    </li>
                ))}
            </ul>
